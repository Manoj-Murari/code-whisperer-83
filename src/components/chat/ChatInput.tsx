    ...
    <div className="border-t border-border bg-background p-6">
      <div className="max-w-3xl mx-auto">
        <div className="relative flex items-end gap-2">
          <div className="flex-1 relative">
            <Textarea
              ...
              className="min-h-[44px] max-h-[120px] resize-none rounded-lg bg-background border-border focus:border-foreground/30 focus:ring-0 transition-colors pr-12 text-sm"
              disabled={isAgentThinking}
            />
            <Button
              variant="ghost"
              size="icon"
              className="absolute right-2 bottom-2 h-7 w-7 text-muted-foreground hover:text-foreground hover:bg-muted"
              disabled={isAgentThinking}
            >
          ...
          <motion.div whileTap={{ scale: 0.96 }}>
            <Button
              ...
              className="h-[44px] px-5 rounded-lg bg-foreground text-background hover:bg-foreground/90 transition-colors shadow-sm"
            >
        ...
        <div className="mt-2 text-xs text-muted-foreground text-center">
          <kbd className="px-1.5 py-0.5 rounded bg-muted border border-border text-[10px]">⌘ + Enter</kbd> to
          send
        </div>
      </div>
    </div>
